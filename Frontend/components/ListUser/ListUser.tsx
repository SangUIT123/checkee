...
export default function ListUser() {
  ...
  let value = {
    ...
    actionName: ["createUser", "updateUser", "deleteUser","blockStatusUser", "openStatusUser"],
  };
                      ...
                      <TableRow key={index}>
                       ...
                       >
                        ...
                        <TableCell scope="row" component="th" align="center">
                          ...
                          { checkBlockStatusUser ? ( row.status === 1 ? iconBlockStatus(row) : "" ) : null }
                          { checkOpenStatusUser ? (  row.status === 0 ? iconOpenStatus(row) : "" ) : null}
