...
import { IListUser1, updateData } from "./../../redux/actions/ListUserActions";
        ...
        <MuiDialogContent dividers className={classes.dialogcontent}>
          <Formik
            initialValues={{
              ...
              birthday: props.createData
                ? moment(props.createData.birthday).utc().format("YYYY-MM-DD")
                : "",
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={6}>
                      <TextField
                        ...
                        required
                        onChange={propss.handleChange}
                        value={propss.values.birthday}
                        error={
                          propss.touched.birthday &&
                          Boolean(propss.errors.birthday)
                        }
                        helperText={
                          propss.touched.birthday && propss.errors.birthday
                        }
                      />
                    </Grid>
                    {/*--------------------------------------------Email------------------------------------------ */}
