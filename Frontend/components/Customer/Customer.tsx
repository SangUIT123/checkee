...
function Customer() {
  ...
  const [selectingCustomer, setSelectingCustomer] = useState(null);
  ...
  const [checkCreateCustomer, setCheckCreateCustomer] = React.useState(
    false
  );
  const [checkUpdateCustomer, setCheckUpdateCustomer] = React.useState(
    false
  );
  const [checkDeleteCustomer, setCheckDeleteCustomer] = React.useState(
    false
  );
        ...
        <div className="row">
          <Grid container>
            ...
            <Grid item xs>
              <CardActions>
                {checkCreateCustomer ? (
                  <Customer_Form_TEST checkEdit={false} />
                ) : null}
              </CardActions>
            </Grid>
          </Grid>
