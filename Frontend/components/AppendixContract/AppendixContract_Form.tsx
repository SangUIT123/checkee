...
import { updateAppendixContractStart, createAppendixContractStart } from '../../redux/actions/AppendixContractActions'
...
export default function AppendixContract_Form(props){
  ...
  const [appendixContract, setAppendixContract] = React.useState(null);
  ...
  const initialFormValues = {
    id: appendixContract? appendixContract._id : "",
    customerId: appendixContract ? appendixContract.customerId : "600fc2ee4b2cdb22e0f7927e",
    numberAppendixContract: appendixContract ? appendixContract.numberAppendixContract : "12345678",
    nameContract: appendixContract ? appendixContract.nameContract : "ddwdqw",
    ...
    packageBuy: appendixContract ? appendixContract.packageBuy : "Trial",
    contractValue: appendixContract ? appendixContract.contractValue : 0,
    vat: appendixContract ? appendixContract.vat : 0, // 0 -> 100
    vatPrice: appendixContract ? (parseFloat(appendixContract.contractValue) * parseFloat(appendixContract.vat)).toFixed(5) : null, // tính toán từ contractValue * vat,
    publicKey: appendixContract ? appendixContract.publicKey : "123",
    privateKey: appendixContract ? appendixContract.privateKey : "456",
    fileDoc: appendixContract ? appendixContract.fileDoc : "",
  }

  const validationSchema = yup.object().shape({
    customerId: yup.string().required('Trường customerId là bắt buộc'),
    numberAppendixContract: yup.string().required('Trường số hợp đồng là bắt buộc'),
    ...
    <React.Fragment>
      <MuiPickersUtilsProvider utils={DateFnsUtils}>
        <FormModal
          ...
          action={checkEdit ? updateAppendixContractStart : createAppendixContractStart} 
                    ...
                    <Grid item>
                        ...
                        <InputLabel id="" style={{ marginLeft : "10px"}}>
                          ...
                          <TextField
                            ...
                            error={
                              props.touched.numberAppendixContract && Boolean(props.errors.numberAppendixContract)
                            }
                            helperText={props.touched.numberAppendixContract && props.errors.numberAppendixContract}
                          />
                    </Grid>
                        <Grid item xs={12}  className={classes.gridItem}>
