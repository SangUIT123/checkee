...
export default function ManagementMenu() {
   ...
   const [checkCreateManagementMenu, setCheckCreateManagementMenu] = React.useState(
     false
   );
   const [checkUpdateManagementMenu, setCheckUpdateManagementMenu] = React.useState(
     false
   );
   const [checkDeleteManagementMenu, setCheckDeleteManagementMenu] = React.useState(
     false
   );
   ...
   let value = {
     ...
     actionName: ["createManagementMenu", "updateManagementMenu", "deleteManagementMenu"],
   };
  ...
  const handleClickOpenModalUpdate = (id): void => {
  ...
  const hanldeClickCloseModalUpdate = () => {
                        ...
                        <Grid container spacing={0} justify="center">
                          <Grid item xs={12} md={6}>
                            <Button
                              ...
                              onClick={() =>
                                handleClickOpenModalUpdate(row._id)
                              }
                                ...
                                <Grid container spacing={0} justify="center">
                                  <Grid item md={6} xs={12}>
                                    <Button
                                      ...
                                      className={classes.button1}
                                      onClick={() =>
                                        handleClickOpenModalUpdate(rows._id)
                                      }
                                      disabled={!checkUpdateManagementMenu}
                                    >
                                      <Icon
  ...
  return (
    <div className="main-content">
      ...
      <ManagementMenuForm openModal={modal} closeModal={hanldeClickClose} />
      <ManagementMenuFormUpdate
        openModalUpdate={modalUpdate}
        closeModalUpdate={hanldeClickCloseModalUpdate}
