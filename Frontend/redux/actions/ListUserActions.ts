...
export function loadDataSuccess(data: IListUser[], loading: boolean) {
  return {
...
//tạo dữ liệu
export function createData(values: IListUser1) {
  return {
...
export function createDataSuccess(data: IListUser[], loading: boolean) {
  return {
...
//cập nhật dữ liệu
export function updateData(values: IListUser1) {
  return {
...
export function updateDataSuccess(data: IListUser[], id: IListUser1) {
  return {
...
export function updateStatusNoActiveSuccess(data: IListUser[], id: IListUser) {
  return {
