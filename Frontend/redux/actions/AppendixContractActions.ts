...
/* GET ALL APPENDIX_CONTRACT */
  ...
  export function deleteAppendixContractStart(updates: IAppendixContract) {
    return {
  ...
  export function deleteAppendixContractSuccess(data: IAppendixContract[]) {
    return {
